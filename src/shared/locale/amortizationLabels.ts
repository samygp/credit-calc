...
export const AmortizationRowLocale: LocaleTranslation<keyof IAmortizationRow> = {
    en: {
        ...
        accPrincipal: 'Accumulated Principal',
        accInterest: 'Accumulated Interest',
        accInsurance: 'Accumulated Insurance',
        accNonPrincipal: 'Accumulated Costs (Non-Principal)',
        accTotal: 'Accumulated Total',
        accSavings: 'Accumulated Savings',
    },
    es: {
        id: 'Periodo',
        principal: 'Capital',
